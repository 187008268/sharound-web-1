...
Sharound.prototype.initTemplates = function() {
  this.templates = {};
...
Sharound.prototype.viewHome = function() {
  this.getAllItems();
};

Sharound.prototype.viewList = function(filters, filter_description) {
  ...
  var renderer = {
    ...
    display: function(doc) {
      ...
      data['go_to_item'] = function() {
        that.router.navigate('/items/' + doc.id);
      };
      ...
      // Setting the id allows to locating the individual item card
...
Sharound.prototype.viewSetup = function() {
  var headerEl = this.renderTemplate('header-base', {
    hasSectionHeader: false
  });

  var config = this.getFirebaseConfig();
  var noItemsEl = this.renderTemplate('no-items', config);

  var button = noItemsEl.querySelector('#add_mock_data');
  ...
  button.addEventListener('click', function(event) {
    ...
    that.addMockItems().then(function() {
      that.rerender();
    });
  });

  this.replaceElement(document.querySelector('.header'), headerEl);
  this.replaceElement(document.querySelector('main'), noItemsEl);
...
Sharound.prototype.initReviewDialog = function() {
...
Sharound.prototype.initFilterDialog = function() {
...
Sharound.prototype.updateQuery = function(filters) {
  var query_description = '';

  if (filters.category !== '') {
    query_description += filters.category + ' places';
  } else {
    query_description += 'any item';
  }
...
Sharound.prototype.viewItem = function(id) {
  var sectionHeaderEl;
...
Sharound.prototype.renderTemplate = function(id, data) {
...
Sharound.prototype.render = function(el, data) {
  if (!data) {
    return;
  }
...
Sharound.prototype.useModifier = function(el, selector, modifier) {
  el.querySelectorAll('[' + selector + ']').forEach(modifier);
};

Sharound.prototype.getDeepItem = function(obj, path) {
...
Sharound.prototype.renderRating = function(rating) {
...
Sharound.prototype.renderPrice = function(price) {
...
Sharound.prototype.replaceElement = function(parent, content) {
  parent.innerHTML = '';
  parent.append(content);
};

Sharound.prototype.rerender = function() {
