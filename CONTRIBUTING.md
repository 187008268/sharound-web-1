...
As contributors and maintainers of the Sharound-web project, we pledge to respect everyone who contributes by posting issues, updating documentation, submitting pull requests, providing feedback in comments, and any other activities.
...
If any member of the community violates this code of conduct, the maintainers of the Sharound-web project may take action, removing issues, comments, and PRs or blocking accounts as deemed appropriate.
...
If you have questions about how to use the Sharound-web, please open a Github issue. If you need help debugging your own app, please please direct these to [StackOverflow][stackoverflow] and use the `firebase` tag.
...
* Search [GitHub](https://github.com/firebase/Sharound-web/pulls) for an open or closed Pull Request
...
* In GitHub, send a pull request to `Sharound-web:master`.
