...
Sharound is an item sharing web app based on FriendlyEats sample built on Cloud Firestore.
...
[![Build Status](https://travis-ci.org/firebase/Sharound-web.svg?branch=master)](https://travis-ci.org/firebase/Sharound-web)
